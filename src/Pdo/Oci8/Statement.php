...
class Statement extends PDOStatement
{
    ...
    public function fetch(
        ...
        switch ($fetchMode) {
            ...
            case PDO::FETCH_COLUMN:
                // Keep LOB locators so only the requested column is loaded.
                $rs = oci_fetch_array($this->sth, OCI_NUM | OCI_RETURN_NULLS);
    ...
    public function closeCursor(): bool
    {
        ...
        // A caller may already have released a cursor passed to the constructor.
